...
export const errors = {
    'RU': [
        ...
        'Поддерживается только одна ось поворота', //18 Fanuc
        'Ошибка при парсинге аргумента паузы',   //19
    ],
    'EN': [
        'Parsing error' , //0
        ...
        'Rotation function analysis only supports one axis', //18
        'Error parsing pause argument', //19
    ]
}
